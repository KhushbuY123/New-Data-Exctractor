  ...
  const onFileDrop = (e) => {
    ...
    if (newFile) {
      if (newFile.type === "application/pdf") {
        ...
        console.log("File type is an image:", newFile.type);
        props.setImgFile(newFile);
    ...
    <>
      ...
      {!file && (
        ...
        >
          ...
          <input type="file" accept=".pdf,.jpg,.jpeg,.png" value="" onChange={onFileDrop} />
        </Button>
      )}
      {file ? (
      ...
      >
        <Alert onClose={handleClose} severity="error" sx={{ width: "100%" }}>
          Please upload a PDF or image file only
        </Alert>
      </Snackbar>
    </>
  );
